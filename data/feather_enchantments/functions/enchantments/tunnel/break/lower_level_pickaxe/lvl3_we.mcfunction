#> feather_enchantments:enchantments/tunnel/break/lower_level_pickaxe/lvl3_we
...
function feather_enchantments:enchantments/tunnel/break/lower_level_pickaxe/lvl2_we